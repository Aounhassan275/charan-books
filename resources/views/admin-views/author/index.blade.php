...
@section('title', translate('Add new author'))
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="card--header">
                            <h5 class="card-title">Author Table<span class="badge badge-soft-secondary">{{ $authors->total() }}</span> </h5>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn--container justify-content-center">
                                            ...
                                            <a class="action-btn btn--danger btn-outline-danger" href="javascript:"
                                                onclick="form_alert('author-{{$author->id}}','{{ translate('Want to delete this') }}')">
                                                <i class="tio-delete-outlined"></i>
                                            </a>
                                        </div>
                                        <form action="{{route('admin.author.destroy',[$author->id])}}"
                                                method="post" id="author-{{$author->id}}">
                                            @csrf @method('delete')
                                        </form>
                                        <!-- End Dropdown -->
                                    </td>
